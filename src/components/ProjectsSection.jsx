...
const ProjectsSection = memo(
  ({ projectData, handleImageLoad, loadedImages }) => {
    return (
            ...
            {projectData.map((value, index) => (
              ...
              >
                ...
                <div className="mt-auto flex items-center justify-end space-x-6 pt-4 border-t border-slate-200">
                  <button className="px-6 py-2 space-x-2 min-w-[120px] text-center text-white bg-violet-600 border border-violet-600 rounded active:text-violet-500 hover:bg-transparent hover:text-violet-600 focus:outline-none">
                    <FontAwesomeIcon icon={faGithub} />
                    <span>Code</span>
                  </button>
                  <button className="px-6 py-2 space-x-2 min-w-[120px] text-center text-violet-600 border border-violet-600 rounded hover:bg-violet-600 hover:text-white active:bg-indigo-500 focus:outline-none">
